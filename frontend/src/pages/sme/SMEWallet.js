...
export default function SMEWallet() {
  return (
    <DashboardShell navItems={nav}>
      <div className="animate-slide-up">
        <h1 className="font-display text-3xl text-white mb-6">Wallet</h1>
        <div className="card p-8 text-center text-slate-500">Wallet details coming soon.</div>
      </div>
    </DashboardShell>
  );
}
